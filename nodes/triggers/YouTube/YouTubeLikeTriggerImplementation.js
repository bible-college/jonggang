// src/nodes/triggers/youtube/YouTubeLikeTriggerImplementation.js
const ITriggerImplementation = require('../../../core/ITriggerImplementation');

/**
 * @class YouTubeLikeTriggerImplementation
 * 특정 유튜브 비디오의 '좋아요' 수 변화를 감지하는 구체적인 구현체.
...
class YouTubeLikeTriggerImplementation extends ITriggerImplementation {
    constructor(videoId) {
        ...
        this.triggerCallback = null; // startListening에서 받은 콜백을 저장
        this.hasTriggered = false; // 1회성 트리거 시뮬레이션을 위한 플래그
    }
